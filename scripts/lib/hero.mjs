...
<defs><clipPath id="portrait-window"><rect x="${frame.x}" y="${frame.y}" width="${frame.w}" height="${frame.h}" rx="12"/></clipPath><linearGradient id="edge"><stop stop-color="${blue}"/><stop offset="1" stop-color="${green}"/></linearGradient><linearGradient id="scan-aura" x1="0%" y1="0%" x2="0%" y2="100%"><stop stop-color="${blue}" stop-opacity="0"/><stop offset=".18" stop-color="${blue}" stop-opacity=".08"/><stop offset=".48" stop-color="${cyan}" stop-opacity=".4"/><stop offset=".72" stop-color="${green}" stop-opacity=".13"/><stop offset="1" stop-color="${cyan}" stop-opacity="0"/></linearGradient><linearGradient id="scan-core"><stop stop-color="${blue}"/><stop offset=".24" stop-color="${cyan}"/><stop offset=".5" stop-color="#E8FFFF"/><stop offset=".73" stop-color="${cyan}"/><stop offset="1" stop-color="${green}"/></linearGradient></defs>
...
<g class="scanner" pointer-events="none"><rect x="24" y="28" width="${width - 48}" height="54" fill="url(#scan-aura)" opacity="0"><animate attributeName="y" values="28;${height - 100};${height - 100};28;28" keyTimes="0;.43;.5;.93;1" dur="12s" repeatCount="indefinite"/><animate attributeName="opacity" values=".18;.68;.5;.6;.18" keyTimes="0;.43;.5;.93;1" dur="12s" repeatCount="indefinite"/></rect><rect x="24" y="28" width="${width - 48}" height="10" fill="url(#scan-aura)" opacity="0"><animate attributeName="y" values="24;${height - 104};${height - 104};24;24" keyTimes="0;.43;.5;.93;1" dur="12s" repeatCount="indefinite"/><animate attributeName="opacity" values=".12;.46;.32;.4;.12" keyTimes="0;.43;.5;.93;1" dur="12s" repeatCount="indefinite"/></rect><rect x="24" y="28" width="${width - 48}" height="1.6" fill="url(#scan-core)" opacity="0"><animate attributeName="y" values="28;${height - 72};${height - 72};28;28" keyTimes="0;.43;.5;.93;1" dur="12s" repeatCount="indefinite"/><animate attributeName="opacity" values=".8;1;.78;.95;.8" dur=".8s" repeatCount="indefinite"/><animateTransform attributeName="transform" type="translate" values="0 0;5 0;-3 0;2 0;-7 0;0 0" dur=".58s" repeatCount="indefinite"/></rect></g>${scanGlitches}
